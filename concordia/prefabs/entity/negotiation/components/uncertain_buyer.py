...
"""
    ...
    def pre_act(self, action_spec) -> str:
        '''No need for actions since its done on pre_observe'''
        pass
    ...
    #     should_gather_info = ((avg_uncertainty > self._risk_tolerance) and info_values and info_values[0] > 0)
    ...
    #         Generate a negotiatnetion action that:
