"""Concordia context component for surfacing simpleKT state to the agent."""
...
class KnowledgeStateContextComponent(
  ...
  """Injects a simpleKT knowledge-state summary into the agent prompt."""

  def __init__(
      self,
      *,
      adapter: SimpleKTAdapter,
